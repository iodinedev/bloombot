import { SlashCommandBuilder, ModalBuilder, TextInputBuilder, ActionRowBuilder, TextInputStyle, ModalActionRowComponentBuilder } from "discord.js";
...
export = {
  ...
  async execute(interaction) {
    ...
    interaction.client.on('interactionCreate', async interaction => {
      ...
      if (termExists && termExists.id !== termData.id) {
